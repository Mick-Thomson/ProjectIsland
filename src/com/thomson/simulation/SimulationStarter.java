...
import com.thomson.island.IslandStatsistics;
...
public class SimulationStarter {
     ...
     */
    private IslandStatsistics islandStatistics;
    ...
    private ExecutorService fillAnimalsToLocation;
    ...
    public SimulationStarter() {
        ...
        this.islandStatistics = new IslandStatsistics(islandMap);
        ...
        this.fillAnimalsToLocation = Executors.newSingleThreadExecutor();
    }
    ...
    public void start() throws InterruptedException {
        ...
        for (int i = 0; i < simulationSettings.getSimulationCycles(); i++) {
            ...
            islandController.getMap().fillPlants(simulationSettings.getMaxPlantCountOnLocation());
            executorService.submit(createLifeCycleTask());
//            if (i != 0) {
...
//        executorService.scheduleWithFixedDelay(createLifeCycleTask(),
//                100, // Вывести в константу SimulationSettings.INITIAL_DELAY_TACT_MILLIS
//                100 , // Вывести в константу SimulationSettings.TACT_TIME_DELAY_MILLIS
